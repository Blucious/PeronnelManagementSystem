 ...
 * @author she
 */
public class ModifyDepartmentDialog extends DataInputDialog {
    public ModifyDepartmentDialog(Window owner) {
        super(owner);
        initComponents();
    }

    public ModifyDepartmentDialog(Window owner, String dno) {
        super(owner);
        initComponents();
        textFieldDeptNo.setText(dno);
        textFieldDeptNo.setEditable(false);
    }
    ...
    private void deletebuttonMouseClicked(MouseEvent e) {
        setInputData(textFieldDeptNo.getText());
        setVisible(false);
    }
